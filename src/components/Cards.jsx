...
const Cards = () => {
  return (
    <div className='w-full h-screen bg-zinc-100 flex items-center px-32 gap-5'>
        <div className='cardcontainer h-[65vh] w-1/2'>
        ...
        <div className='cardcontainer w-1/2 flex gap-5 h-[65vh]'>
                <div className='card relative  items-center justify-center flex rounded-xl w-1/2 h-full bg-[#212121]'>
